            ...
            <div className=" flex-grow px-4 py-4 flex items-center justify-center z-50 w-full h-auto bg-opacity-5 bg-rose-700 pt-5">
                <div className="flex flex-col items-center justify-center pt-1">
                    <div className="flex items-center space-x-2">
                        ...
                        <button type="submit" className="shadow apparence-none bg-rose-950 text-pink-300 hover:bg-rose-300 hover:text-white transition duration-300 px-3 py-2 rounded-3xl text-sm font-medium"><SearchIcon className="size-5" /></button>
                    </div>
